...
public class YamlDataHandler {
	...
	public YamlDataHandler(Plugin plugin) {
		this.plugin = plugin;
	}
	...
	public void initializeScheduledUpdate(final int waitSeconds, final String nameID) {
		...
		plugin.getProxy().getScheduler().schedule(plugin, new Runnable() {
			...
			public void run() {
				...
				//repeat:
				YamlDataHandler.this.initializeScheduledUpdate(waitSeconds, nameID);
			}
	...
	public void initializeScheduledUpdate(final int waitSeconds) {
		plugin.getProxy().getScheduler().schedule(plugin, new Runnable() {
			...
			public void run() {
				...
				//repeat:
				YamlDataHandler.this.initializeScheduledUpdate(waitSeconds);
			}
		}, waitSeconds, TimeUnit.SECONDS);
	}
